...
systempackages () {
apt-get -y install mysql-client unzip build-essential curl privoxy stunnel4 net-tools screen
...
# #!/bin/bash
# HOST='139.59.254.160'
# USER='sql_nox_enseivpn'
# PASS='wFseNtDabYWzWpdh'
# DB='sql_nox_enseivpn'
# PORT='4417'
# EOM7
...
#wget -O /bin/proxy3.py https://raw.githubusercontent.com/Ensei09/Test-Repo/main/YPanel%20Dependencies/proxy3.py -q
#wget -O /bin/auto.sh https://raw.githubusercontent.com/Ensei09/Test-Repo/main/YPanel%20Dependencies/auto.sh -q
#chmod +x /bin/auto.sh
#/bin/auto.sh;
...
echo -e "#       Server System: ENSEI VPN              #"
echo -e "#       SSH Version Only                      #"
...
echo ""
echo -e "${GREEN}Websocket SSH         = 80 ${RESET}"
echo ""
...
# EOM
wget -O /usr/local/sbin/ssh.php https://gist.githubusercontent.com/Ensei09/ac6f0e0c4542e0f3d78df00295bfffa7/raw/8fb8920212b326b91157576623616783d3e89285/prem.sh -q
}
...
# [ "$user_name" != '' ] && [ "$user_name" = "$username" ] && echo "user : $username" && echo 'authentication ok.' && exit 0 || echo 'authentication failed.'; exit 1
# EOM
wget -O /usr/local/sbin/ssh.php https://gist.githubusercontent.com/Ensei09/d1e849765b3030ef491f588997b55f94/raw/310b32844da92052ace1b6d58814df5cadd2ed22/vip.sh -q
}
...
# [ "$user_name" != '' ] && [ "$user_name" = "$username" ] && echo "user : $username" && echo 'authentication ok.' && exit 0 || echo 'authentication failed.'; exit 1
# EOM
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/Ensei09/EnseiVPN/main/EnseiVPN_DNSTT%26UDP/private.sh -q
}
