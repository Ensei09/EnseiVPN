...
$DB_host = "139.59.250.138";
$DB_user = "sql_numataka_ens";
$DB_pass = "KXzyBG2LbPnAesxY";
$DB_name = "sql_numataka_ens";
...
function encrypt_key($paswd)
	...
	{
		$secret_key = md5('*ensei(&)radz^');
		$secret_iv = md5('~radz=ensei#');
